...
/**
 * Default implementation of {@link IExecutorServiceProvider} that uses a fixed platform thread pool.
 */
public final class DefaultExecutorServiceProvider implements IExecutorServiceProvider {
