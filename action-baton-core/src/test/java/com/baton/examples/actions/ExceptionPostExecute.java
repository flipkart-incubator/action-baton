...
public class ExceptionPostExecute implements IAction<ActionExecutionContextImpl, CustomException> {

    @Override
    public String getActionName() {
        return "POST_EXECUTE_EXCEPTION_ACTION";
    }
    ...
    public void postExecute(ActionExecutionContextImpl context) throws CustomException {
        System.out.println("PostExecuteExceptionAction");
