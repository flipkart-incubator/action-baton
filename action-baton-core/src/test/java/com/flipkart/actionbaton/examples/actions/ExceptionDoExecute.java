...
public class ExceptionDoExecute  implements IAction<ActionExecutionContextImpl, CustomException> {

    @Override
    public String getActionName() {
        return "DO_EXECUTE_EXCEPTION_ACTION";
    }

    @Override
    public boolean doExecute(ActionExecutionContextImpl context) throws CustomException {
        System.out.println("Do Execute Exception Action");
        throw new CustomException(getActionName());
    }
