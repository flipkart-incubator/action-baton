...
public class PrintIntegerAction implements IAction<ActionExecutionContextImpl, CustomException> {
    @Override
    public String getActionName() {
        return "PRINT_INTEGER_ACTION";
    }
    ...
    public void execute(ActionExecutionContextImpl context) throws CustomException {
        ...
        System.out.println("Iterator Key : " + context.getLocalContext().get(iteratorKey));
    }
}
